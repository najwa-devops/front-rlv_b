            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4">
                <Card className="w-full max-w-md border-white/20 bg-white/90 shadow-2xl backdrop-blur">
                    <CardHeader className="text-center space-y-2">
                        ...
                        <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-700">Plateforme Banking OCR</p>
                        <CardTitle className="text-2xl font-bold">Relevés Bancaires</CardTitle>
                        <CardDescription>Connectez-vous pour accéder à la gestion bancaire</CardDescription>
                    </CardHeader>
                    <CardContent>
