...
export function UploadInvoicePage({ onUpload }: UploadInvoicePageProps) {
    ...
    const validateFile = (file: File): string | null => {
        if (!acceptedTypes.includes(file.type)) {
            return "Format non supporté. Utilisez PDF, JPG, PNG ou TIFF."
        }
        if (file.size > maxFileSize) {
            return "Fichier trop volumineux. Maximum 20 Mo."
        }
        return null
    }
