...
export function AccountingConfigurationPage({ embedded = false }: AccountingConfigurationPageProps) {
    ...
    function openEdit(row: AccountingConfigRow) {
        ...
        setForm({
            ...
            rib: row.rib,
            ttcEnabled: Boolean(row.ttcEnabled),
        });
        setIsDialogOpen(true);
    }
                ...
                <DialogContent className="w-[98vw] max-w-[98vw] sm:max-w-2xl overflow-y-auto max-h-[95vh]">
                    ...
                    <div className="grid gap-4 py-2">
                        ...
                        <div className="flex items-center gap-2 rounded-md border p-3">
                            <Checkbox
                                id="ttcEnabled"
                                checked={Boolean(form.ttcEnabled)}
                                onCheckedChange={(checked) =>
                                    setForm((prev) => ({ ...prev, ttcEnabled: checked === true }))
                                }
                            />
                            <Label htmlFor="ttcEnabled" className="cursor-pointer">TTC</Label>
                        </div>
                    </div>
                    <DialogFooter>
