...
export function UploadBankPage({ onUpload, onViewBankStatement, isDemoMode }: UploadBankPageProps) {
    ...
    const validateFile = (file: File): string | null => {
        if (!acceptedTypes.includes(file.type)) {
            return "Format non supporté. Utilisez PDF, JPG, JPEG, PNG, XLSX ou XLS."
        }
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center gap-4 text-center px-6">
                            ...
                            <div className="flex items-center gap-4 text-xs text-muted-foreground">
                                <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-muted/50">JPG, PNG, XLSX, XLS</span>
