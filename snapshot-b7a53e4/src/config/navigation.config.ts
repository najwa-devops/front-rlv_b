    ...
    SUPER_ADMIN: [
        ...
        },
        {
            ...
            children: [
                ...
                { id: "global-settings", href: "/settings/general", label: "Paramétrage", icon: Sliders },
    ...
    COMPTABLE: [
        ...
        { id: "admin-dashboard", href: "/dossiers", label: "Tableau de bord", icon: Building2 },
        {
            ...
            children: [
                ...
                { id: "general-settings", href: "/settings/general", label: "Paramétrage", icon: Sliders },
    ...
    },
    {
        ...
        roles: ["COMPTABLE", "SUPER_ADMIN"],
            children: [
                ...
                { id: "bank-validated", href: "/bank/validated", label: "Relevés validés", icon: CheckCircle2, roles: ["COMPTABLE", "SUPER_ADMIN"] },
                { id: "bank-accounted", href: "/bank/accounted", label: "Relevés comptabilisés", icon: CheckCircle2, roles: ["COMPTABLE", "SUPER_ADMIN"] },
            ]
        },
    {
        id: "settings",
        ...
        label: "Configuration",
            ...
            children: [
                ...
                { id: "general-settings", href: "/settings/general", label: "Paramétrage", icon: Sliders, roles: ["COMPTABLE", "SUPER_ADMIN"] },
...
export const ROUTE_METADATA: Record<string, { title: string; breadcrumb?: string }> = {
    ...
    "/settings/accounting-config": { title: "Paramétrage", breadcrumb: "Paramétrage" },
    "/settings/general": { title: "Paramètres globaux - Configuration comptable", breadcrumb: "Paramétrage" },
